...
data.train = cbind(data.subject, data.y, data.x);
names(data.train) = c("subject", "activity", feature.list$featureName[feature.list.filtered]);
...
data.test = cbind(data.subject, data.y, data.x);
names(data.test) = c("subject", "activity", feature.list$featureName[feature.list.filtered]);
